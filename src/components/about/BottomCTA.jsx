...
const WHATSAPP_URL = 'https://wa.me/919770816132?text=Hi,%20I%20would%20like%20to%20contact%20you%20for%20AC%20service.';

export default function BottomCTA() {
    return (
        <section className="bg-[#1cc260] py-20 mt-8">
            <div className="max-w-[1200px] mx-auto px-6 text-center">
                ...
                <p className="text-[16px] text-white/90 font-medium mb-10 max-w-2xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="100">
                    Join thousands of satisfied customers across Bhopal. Book your service today and experience the AC Service difference.
                </p>
